...
def madlibs(adjective, noun):
    ...
    return f"""Once there was a(n) {adjective} dog walking down the street. Little did anyone know, this dog was special. This dog could talk.
                So the {adjective} dog was walking down the street, and ran into a(n) {noun}. He said "Watch out, I'm walking here." The {noun} didn't know
                what to say! What happens next will shock you - click to keep reading."""
